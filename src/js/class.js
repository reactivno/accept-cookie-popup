...
export default class AcceptCookiePopup {
  ...
  constructor( options = {} ) {
    ...
    if ( navigator.cookieEnabled ) {
      ...
      this.#btnText = this.#getOptionFallback( 'btnText', defaultSettings.btnText );
      this.#closeTitle = this.#getOptionFallback( 'closeTitle', defaultSettings.closeTitle );
      this.#messageText = this.#getOptionFallback( 'messageText', defaultSettings.messageText );
      this.#getTemplate();
  ...
  #getTemplate() {
    ...
    <template id="${this.#popupName}">
      <div class="${this.#popupName}">
        <button class="${this.#popupName}__cross ${this.#popupName}__close" type="button" aria-label="${this.#closeTitle}" title="${this.#closeTitle}"></button>
        <div class="${this.#popupName}__container">
          <div>
            ${this.#messageText(this.#siteName.toLocaleUpperCase(), this.#linkCookiePage)}
          </div>
          <button class="${this.#popupName}__btn ${this.#popupName}__close ${this.#popupName}__accept" type="button">${this.#btnText}</button>
        </div>
      </div>
    </template>
    `;
